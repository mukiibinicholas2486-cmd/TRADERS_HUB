...
function validateProposalParameters(
  ...
  if (
    ...
    return {
      valid: false,
      error:
        "This terminal currently supports DIGITMATCH, DIGITEVEN, DIGITODD, DIGITOVER and DIGITUNDER."
    };
...
function updateProposal() {
  ...
  if (
    ...
    /*
     * Even/Odd digit contracts do not use a barrier.
     * The prediction engine supplies the analytical
     * direction for the UI, while Deriv prices the
     * actual contract through the proposal request.
     */

    delete request.barrier;
